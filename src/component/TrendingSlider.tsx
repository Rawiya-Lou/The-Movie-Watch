          ...
          <div className="absolute inset-0 flex flex-col justify-end p-6 md:p-16 bg-gradient-to-t from-primary via-primary/40 to-transparent">
            ...
            >
              <Link
                ...
                className="inline-flex items-center gap-2 bg-accent-three hover:bg-red-600 text-white font-bold py-3 px-8 rounded-lg transition-transform hover:scale-105 active:scale-95 shadow-lg"
              >
                <svg
                  xmlns="http://w3.org"
                  width="20"
